...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/From date_select'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_1'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/From date_select'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/div_31'))
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Password'))
