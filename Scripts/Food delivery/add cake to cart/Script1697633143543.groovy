...
WebUI.click(findTestObject('Object Repository/Delivery/Page_Order food online from Indias best foo_aa25ef/button_CakeDish'))

WebUI.click(findTestObject('Object Repository/Delivery/Page_Order food online from Indias best foo_aa25ef/div_ADD'))

WebUI.click(findTestObject('Object Repository/Delivery/Page_Order food online from Indias best foo_aa25ef/div_Total 415.00Add Item'))

WebUI.click(findTestObject('Object Repository/Delivery/Page_Order food online from Indias best foo_aa25ef/a_1Cart'))
